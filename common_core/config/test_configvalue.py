...
def test_field_invalid_names():
    ...
    for i, bad_name in enumerate(
        ["5TART_WITH_NUMBER", "A", "lower_case_name", "SPEC!@L_CHAR$"]
    ):
        dct = field_vars()
...
def test_compare_values():
    ...
    value2 = ConfigValue(field=field)
